...
public partial class LaberintoParser : Parser {
	...
	public partial class DirectivasContext : ParserRuleContext {
		public ITerminalNode USE() { return GetToken(LaberintoParser.USE, 0); }
		public ITerminalNode IDENT() { return GetToken(LaberintoParser.IDENT, 0); }
	...
	public DirectivasContext directivas() {
		...
		try {
			...
			{
			State = 43; Match(USE);
			State = 44; Match(IDENT);
			State = 45; Match(TIME);
			State = 46; Match(NUMERO);
	...
	public static readonly string _serializedATN =
		...
		"\x2\x2*+\x3\x2\x2\x2+,\x5\x14\v\x2,\x3\x3\x2\x2\x2-.\a\x5\x2\x2./\a\x17"+
